...
default['amanda_part']['amanda_restore_work_dir'] = File.join(node['amanda_part']['amanda_data_dir'], 'restore')
default['amanda_part']['event_handler'] = '/opt/consul/event_handlers/event-handler'
default['amanda_part']['patterns_dir'] = '/opt/cloudconductor/patterns'
default['amanda_part']['backup_restore_file'] = 'config/backup_restore.yml'
...
default['amanda_part']['server']['holding_use'] = '100 mbytes'
...
default['amanda_part']['server']['s3']['tpchanger']['prefix'] = ''
